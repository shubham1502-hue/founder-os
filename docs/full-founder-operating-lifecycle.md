...
Founder OS can be used as one repo at a time or as a connected operating lifecycle. The integrations are operating handoffs, not hard technical dependencies.

## Lifecycle

1. Decide AI leverage and operating priorities.
2. Build RevOps and metrics foundation.
3. Research target accounts.
4. Prepare and run founder-led calls.
5. Learn from calls.
...
| Step | Operating job | Repo |
| --- | --- | --- |
| 1 | Decide which workflows deserve automation, hiring, outsourcing, or manual ownership. | [founder-ai-workflow-roi-os](https://github.com/shubham1502-hue/founder-ai-workflow-roi-os) |
| 2 | Set the operating map and choose modules. | [founder-os](https://github.com/shubham1502-hue/founder-os) |
| 3 | Design CRM, handoffs, reporting, and automation backbone. | [revops-infrastructure-playbook](https://github.com/shubham1502-hue/revops-infrastructure-playbook) |
| 4 | Define metrics before dashboards harden bad assumptions. | [startup-metrics-playbook](https://github.com/shubham1502-hue/startup-metrics-playbook) |
| 5 | Research target accounts and prepare calls. | [ai-gtm-command-center](https://github.com/shubham1502-hue/ai-gtm-command-center) |
...
Use outputs as handoff artifacts:

- Account briefs and outreach drafts become sales call prep.
